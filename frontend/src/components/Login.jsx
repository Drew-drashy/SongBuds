...
//         style={{
//             backgroundImage: 'url("https://res.cloudinary.com/dqp1z12my/image/upload/v1725868230/pexels-pixabay-164745_swxusb.jpg")', // Replace the URL with your desired image URL
...
//                 className="p-2 w-full max-w-xs rounded-md border-transparent focus:border-gray-500 focus:ring-0"
//             />
//             <button type="submit" className="px-6 py-2 text-white bg-violet-500 rounded-md hover:bg-violet-600">Login</button>
//             </form>
//         </div>
//         </div>
